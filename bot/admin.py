...
main_channel_id = os.getenv('CHANNEL_CHAT_ID')
...
@admin_router.channel_post((F.chat.id == main_channel_id), F.media_group_id)
@media_group_handler
...
@admin_router.channel_post(F.chat.id == main_channel_id)
